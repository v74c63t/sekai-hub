          ...
          (
            <div className="update-post-form">
              ...
              >
                ...
                <button className={`${theme}-bg update-post-btn ${theme}-bg-hover`} type="submit" onClick={handleUpdatePost}>Update Post</button>
                <Dialog
                  open={open}
                  onClose={handleClose}
                    ...
                    <>
                      ...
                      <DialogActions className="dialog-actions">
                        <div className="dialog-btns-container">
                          ...
                          <div className={`${theme}-bg dialog-btns ${theme}-bg-hover`} onClick={()=>navigate(`/post/${id}`)}>View Post</div>
                        </div>
                      </DialogActions>
                    </>
                  ): ""}
          ...
          >
            ...
            (
              <>
                ...
                <DialogActions className="dialog-actions">
                  <div className="dialog-btns-container">
                    <div className={`${theme}-bg secret-key-dialog-btns ${theme}-bg-hover`} onClick={()=>navigate('/')}>Back to Home</div>
                    <div className={`${theme}-bg secret-key-dialog-btns ${theme}-bg-hover`} onClick={checkSecretKey}>Confirm</div>
                  </div>
                </DialogActions>
              </>
            )}
